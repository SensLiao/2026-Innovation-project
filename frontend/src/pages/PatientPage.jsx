...
const PatientPage = () => {
  ...
  const [sort, setSort] = useState({ key: "pid", dir: "asc" });
  ...
  const rows = useMemo(() => {
    ...
    if (genderFilter !== "all") {
      filtered = filtered.filter(
        (p) => String(p.gender || "").toLowerCase() === genderFilter.toLowerCase()
      );
    }
  ...
  }, [patients, q, sort, searchKey, genderFilter]);
    ...
    <div className="min-h-screen bg-[#C2DCE7] py-8">
      <div className="relative w-full max-w-6xl">
        ...
        <div className="mx-auto w-[1200px]">
          <div className="bg-white rounded-3xl shadow-2xl p-8 relative w-full overflow-hidden">
            <Header
              activeTab="patient"
              showLogout={true}
                        ...
                        <th key={key} className="px-4">
                          {key === "gender" ? (
                            <select
                              ...
                              className="rounded-2xl border-2 border-black bg-white px-5 py-3 text-black font-medium focus:outline-none cursor-pointer"
                          ...
                          <div className="row-card w-20 text-center">
                            {isEditing ? (
                              <input
                                ...
                                onChange={(e) =>
                                  setEditFields((f) => ({ ...f, age: e.target.value }))
                                }
                              />
                            ) : (
                              age
