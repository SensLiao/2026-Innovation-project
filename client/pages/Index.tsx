...
const patientData = [
  { id: 1, name: "Emily Carter", age: 28, gender: "Female", dateCreated: "Dec 5", time: "12:30" },
  { id: 2, name: "James Nguyen", age: 34, gender: "Male", dateCreated: "Dec 5", time: "12:30" },
  { id: 3, name: "Sophia Martinez", age: 43, gender: "Female", dateCreated: "Dec 5", time: "12:30" },
  { id: 4, name: "Liam Johnson", age: 19, gender: "Male", dateCreated: "Dec 5", time: "12:30" },
  { id: 5, name: "Olivia Wang", age: 26, gender: "Female", dateCreated: "Dec 5", time: "12:30" },
  { id: 6, name: "Benjamin Patel", age: 27, gender: "Male", dateCreated: "Dec 5", time: "12:30" },
  { id: 7, name: "Teresa Chen", age: 21, gender: "Female", dateCreated: "Dec 5", time: "12:30" },
  { id: 8, name: "Karen Hu", age: 21, gender: "Female", dateCreated: "Dec 5", time: "12:30" },
  { id: 9, name: "Sens Liao", age: 20, gender: "Male", dateCreated: "Dec 5", time: "12:30" },
  { id: 10, name: "Steven Cai", age: 22, gender: "Male", dateCreated: "Dec 5", time: "12:30" },
];
          ...
          <div className="px-6 lg:px-0 max-w-full overflow-x-auto">
            <div className="bg-white rounded-lg overflow-hidden min-w-full">
              ...
              <div className="grid grid-cols-7 gap-5 py-4 bg-white min-w-[1000px] lg:min-w-full">
                <div className="text-gray-500 font-medium text-base w-16">RID</div>
                ...
                <div className="text-black font-medium text-base text-center w-28">Date Created</div>
                <div className="text-black font-medium text-base w-24 text-center">Time</div>
              ...
              <div className="divide-y divide-table-border">
                {patientData.map((patient) => (
                  <div key={patient.id} className="grid grid-cols-7 gap-5 py-4 hover:bg-gray-50 transition-colors border-t border-table-border min-w-[1000px] lg:min-w-full">
                    ...
                    <div className="text-gray-500 text-base text-center w-28">{patient.dateCreated}</div>
                    <div className="text-black text-base font-medium w-24 text-center">{patient.time}</div>
